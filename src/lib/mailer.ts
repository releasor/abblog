...
export function notificationEmailTemplate(
  ...
  return `
    <div style="font-family:system-ui,sans-serif;max-width:600px;margin:0 auto;padding:24px;">
      ...
      ${link ? `<a href="${link}" style="display:inline-block;margin-top:16px;padding:8px 20px;background:#18181b;color:#fff;text-decoration:none;border-radius:8px;font-size:14px;">查看</a>` : ""}
