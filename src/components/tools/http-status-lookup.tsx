    ...
    <div className="space-y-4">
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2 text-sm border border-zinc-300 dark:border-zinc-700 rounded-lg bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-500"
        />
      </div>
      <div className="space-y-4">
        {categories.map((cat) => (
